...
angular.module('brusnika', ['naif.base64','ionic', 'brusnika.controllers', 'brusnika.services','ngMaterial', 'firebase','ngStorage','ngMask','ionic.cloud'])
...
.config(function($stateProvider, $urlRouterProvider,$mdThemingProvider,$ionicCloudProvider) {
